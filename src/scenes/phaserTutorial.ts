...
export default class PhaserTutorial extends Phaser.Scene {
    ...
    constructor() {
        console.log('Constructing PhaserTutorial scene...');
        super({
            key: 'PhaserTutorial',
            physics: {
                arcade: {
    ...
    preload() {
        ...
        this.load.spritesheet(this.dude, dudeUrl, {frameWidth: 32, frameHeight: 48});
    }

    create() {
        console.log('Starting PhaserTutorial scene...');
        ...
        this.physics.add.overlap(this.player, this.stars, this.collectStar, function () {}, this);

        this.bombs = this.physics.add.group();
        this.physics.add.collider(this.bombs, this.platforms);
        this.physics.add.collider(this.player, this.bombs, this.hitBomb, function () {}, this);
    ...
    collectStar(_player: Phaser.GameObjects.GameObject, star: Phaser.GameObjects.GameObject): void {
    ...
    hitBomb(player: Phaser.GameObjects.GameObject, _bomb: Phaser.GameObjects.GameObject): void {
        this.physics.pause();
